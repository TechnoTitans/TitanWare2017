...
//	private Mat hslThresholdOutput = new Mat(), sourceRoi = new Mat(), hslImage = new Mat();
...
//	// region of interest, form (x, y, width, height) SHOULD TUNE!
//	Rect roi = new Rect(400, 200, 100, 100);
//	// fraction of pixels that need to be in the range for gear to be counted
//	private static final double AVERAGE_PIXEL_THRESHOLD = 0.8;
//
...
//			// If the number of non-zero (white, inside the range) pixels is
//			// bigger than 0.8*10000
