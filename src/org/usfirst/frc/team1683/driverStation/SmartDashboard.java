...
public class SmartDashboard
    extends edu.wpi.first.wpilibj.smartdashboard.SmartDashboard {
  /**
  ...
  public static void sendData(String key, double val) {
    try {
      edu.wpi.first.wpilibj.smartdashboard.SmartDashboard.putNumber(key,
                                                                    val);
  ...
  public static void sendData(String key, String val) {
    try {
      edu.wpi.first.wpilibj.smartdashboard.SmartDashboard.putString(key,
                                                                    val);
    } catch (IllegalArgumentException e) {
    }
  }
  ...
  public static void sendData(String key, boolean val) {
    try {
      edu.wpi.first.wpilibj.smartdashboard.SmartDashboard.putBoolean(key,
                                                                     val);
    } catch (IllegalArgumentException e) {
    }
  }
  ...
  /**
   * Receives the value from roboRIO Default is false if no boolean value
   * is
   * found with the key
   *
   * @param key
  ...
  /**
   * Receives the value from roboRIO Default is "null" if no string is
   * found
   * with the key
   *
   * @param key
  ...
  /**
   * Receives the value from roboRIO Default is 0.0 if no double is found
   * with
   * the key
   *
   * @param key
  ...
  /**
   * Receives the value from roboRIO Default is 0 if no integer found with
   * the
   * key
   *
   * @param key
